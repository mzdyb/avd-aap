...
| ------------------| ----------- | ------------ | ------------ | ------------- | ----------------- | ------------------ |
| dc1-leaf1a | 51 | 47 | 0 | 4 | - | Hardware |
| dc1-leaf1b | 51 | 47 | 0 | 4 | - | Hardware |
| dc1-leaf2a | 51 | 47 | 0 | 4 | - | Hardware |
| dc1-leaf2b | 51 | 47 | 0 | 4 | - | Hardware |
...
| 48 | dc1-leaf1a | Routing | VerifyRoutingTableEntry | Verifies that the provided routes are present in the routing table of a specified VRF. | Route: 10.255.1.3 - Peer: dc1-leaf1b | PASS | - |
...
| 50 | dc1-leaf1a | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
...
| 99 | dc1-leaf1b | Routing | VerifyRoutingTableEntry | Verifies that the provided routes are present in the routing table of a specified VRF. | Route: 10.255.1.3 - Peer: dc1-leaf1b | PASS | - |
...
| 101 | dc1-leaf1b | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
...
| 150 | dc1-leaf2a | Routing | VerifyRoutingTableEntry | Verifies that the provided routes are present in the routing table of a specified VRF. | Route: 10.255.1.3 - Peer: dc1-leaf1b | PASS | - |
...
| 152 | dc1-leaf2a | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
...
| 201 | dc1-leaf2b | Routing | VerifyRoutingTableEntry | Verifies that the provided routes are present in the routing table of a specified VRF. | Route: 10.255.1.3 - Peer: dc1-leaf1b | PASS | - |
...
| 203 | dc1-leaf2b | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
...
| 231 | dc1-spine1 | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
...
| 259 | dc1-spine2 | System | VerifyNTP | Verifies if NTP is synchronised. | - | PASS | - |
