...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.1.5/16 | 172.20.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAF2 | Vlan4094 | 10.255.1.69 | Port-Channel55 |
...
| Ethernet55 | MLAG_dc1-leaf2b_Ethernet55 | *trunk | *- | *- | *MLAG | 55 |
| Ethernet56 | MLAG_dc1-leaf2b_Ethernet56 | *trunk | *- | *- | *MLAG | 55 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49 | P2P_dc1-spine1_Ethernet3 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet50 | P2P_dc1-spine2_Ethernet3 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
interface Ethernet55
   description MLAG_dc1-leaf2b_Ethernet55
   no shutdown
   channel-group 55 mode active
!
interface Ethernet56
   description MLAG_dc1-leaf2b_Ethernet56
   no shutdown
   channel-group 55 mode active
```
...
| Port-Channel55 | MLAG_dc1-leaf2b_Port-Channel55 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel55
   description MLAG_dc1-leaf2b_Port-Channel55
   no shutdown
   switchport mode trunk
...
| Loopback20 | DIAG_VRF_VRF20 | VRF20 | 10.255.20.5/32 |
...
| Vlan3019 |  VRF20  |  10.255.1.100/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF20 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
ip address virtual source-nat vrf VRF20 address 10.255.20.5
```
