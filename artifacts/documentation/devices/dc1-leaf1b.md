...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.1.4/16 | 172.20.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| LEAF1 | Vlan4094 | 10.255.1.64 | Port-Channel55 |
...
| Ethernet55 | MLAG_dc1-leaf1a_Ethernet55 | *trunk | *- | *- | *MLAG | 55 |
| Ethernet56 | MLAG_dc1-leaf1a_Ethernet56 | *trunk | *- | *- | *MLAG | 55 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49 | P2P_dc1-spine1_Ethernet2 | - | 10.255.255.5/31 | default | 1500 | False | - | - |
| Ethernet50 | P2P_dc1-spine2_Ethernet2 | - | 10.255.255.7/31 | default | 1500 | False | - | - |
...
| Port-Channel55 | MLAG_dc1-leaf1a_Port-Channel55 | trunk | - | - | MLAG | - | - | - | - |
...
| Loopback20 | DIAG_VRF_VRF20 | VRF20 | 10.255.20.4/32 |
...
| 10.255.1.96 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF20 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
