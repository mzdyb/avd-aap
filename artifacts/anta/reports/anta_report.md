...
| ------------------| ----------- | ------------- | ------------- | ------------- | ----------- | -------------------| ------------------|
| dc1-leaf1a | 33 | 26 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
| dc1-leaf1b | 33 | 26 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
| dc1-leaf2a | 33 | 26 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
| dc1-leaf2b | 33 | 26 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
| dc1-spine1 | 27 | 20 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
| dc1-spine2 | 27 | 20 | 4 | 3 | 0 | Hardware, Interfaces | Configuration, Interfaces, Logging |
...
| dc1-leaf1a | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.4 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-leaf1a (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-leaf1a | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 821 |
...
| dc1-leaf1a | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:30 leaf1a NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:51 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> <br> |
...
| dc1-leaf1b | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.7 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-leaf1b (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-leaf1b | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 815 |
...
| dc1-leaf1b | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:31 leaf1b NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:51 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> <br> |
...
| dc1-leaf2a | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.3 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-leaf2a (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-leaf2a | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 818 |
...
| dc1-leaf2a | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:31 leaf2a NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:51 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> <br> |
...
| dc1-leaf2b | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.2 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-leaf2b (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-leaf2b | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 820 |
...
| dc1-leaf2b | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:31 leaf2b NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:52 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> Jun 22 11:40:12 dc1-leaf2b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 10.255.0.1 (VRF default AS 65100) 6/7 (Cease/connection collision resolution) 0 bytes <br> <br> |
...
| dc1-spine1 | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.5 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-spine1 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-spine1 | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 821 |
...
| dc1-spine1 | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:31 spine1 NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:51 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> Jun 22 11:40:12 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: sent to neighbor 10.255.0.6 (VRF default AS 65102) 6/7 (Cease/connection collision resolution) 0 bytes <br> <br> |
...
| dc1-spine2 | Configuration | VerifyRunningConfigDiffs | Verifies there is no difference between the running-config and the startup-config. | Generated by AVD | failure | --- flash:/startup-config<br>+++ system:/running-config<br>@@ -1,4 +1,4 @@<br>-! device: sw-172.20.1.6 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br>+! device: dc1-spine2 (cEOSLab, EOS-4.33.2F-40713977.4332F (engineering build))<br> !<br> no aaa root<br> !<br> |
...
| dc1-spine2 | Interfaces | VerifyInterfaceDiscards | Verifies that the interfaces packet discard counters are equal to zero. | Generated by AVD | failure | Interface: Management1 - Non-zero discard counter(s): inDiscards: 821 |
...
| dc1-spine2 | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | Generated by AVD | failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>Jun 22 09:32:31 spine2 NorCalInit: %HARDWARE-0-SYSTEM_IDENTIFICATION_FAILED: Failed to identify this system<br> Jun 22 09:39:52 sw-172 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=885) -- Master ProcMgr (PID=885) exiting.<br> <br> |
